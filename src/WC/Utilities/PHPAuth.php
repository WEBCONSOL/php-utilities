...
final class PHPAuth
{
    ...
    public static final function getUsername(): string {self::loadData();return self::$username;}

    public static final function getPassword(): string {self::loadData();return self::$password;}

    public static final function getClientId(): string {self::loadData();return self::$username;}

    public static final function getClientSecret(): string {self::loadData();return self::$password;}

    public static final function getBasicToken(): string {
    ...
    public static final function getDigestToken(): string {
    ...
    public static final function getBearerToken(): string {
